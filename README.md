<div align="center">
  <a href="https://github.com/rubiconsx">
    <picture>
      <img src="https://raw.githubusercontent.com/rubiconsdev/content/uploads/images/logo.png" alt="Rubicons Logo" height="70">
    </picture>
  </a>
</div>

## rubicons-ads-sdk
Android library for displaying multiple Ad Networks developed by [rubicons]
...
```gradle
dependencies {
    implementation 'com.github.rubiconsx.ads:[ad-sdk-name]:[version]'
}
```
